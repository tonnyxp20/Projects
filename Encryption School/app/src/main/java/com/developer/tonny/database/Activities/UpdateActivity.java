...
public class UpdateActivity extends AppCompatActivity {
    ...
    public void actualizar(View view) {
        ...
        String paterno = encode.encriptar(edtPaterno.getText().toString());
        String materno = encode.encriptar(edtMaterno.getText().toString());
    ...
    public void buscar(View view) {
        ...
        try {
            ...
            edtNombre.setText(encode.desencriptar(respuesta[0]));
            edtPaterno.setText(encode.desencriptar(respuesta[1]));
            edtMaterno.setText(encode.desencriptar(respuesta[2]));

            String fecha[] = encode.desencriptar(respuesta[3]).split("/");
            showDate(Integer.parseInt(fecha[2])
                    , Integer.parseInt(fecha[1])
                    , Integer.parseInt(fecha[0]));

            txtEdad.setText(encode.desencriptar(respuesta[4]) + " años");
            setSpinText(spinnerCarrera, encode.desencriptar(respuesta[5]));
