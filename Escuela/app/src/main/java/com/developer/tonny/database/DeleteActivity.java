...
public class DeleteActivity extends AppCompatActivity {
    ...
    public void eliminar(View view) {
        try {
            String respuesta = cn.post("http://tonnyxp20.x10host.com/eliminarEstudiante.php", matricula);
    ...
    public void buscar(View view) {
        ...
        try {
            ...
            txtNombres.setText(respuesta[0]);
            txtApellidos.setText(respuesta[1] + " " + respuesta[2]);
            txtCarrera.setText(respuesta[5]);
